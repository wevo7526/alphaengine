...
class RiskManager(BaseAgent):
    ...
    def build_input_prompt(self, context: dict) -> str:
        ...
        return (
            ...
            f"You may optionally include a `citations` array on each risk factor with "
            f"source_type/source_id pairs referencing the tool calls that surfaced the risk. "
            f"Citations are OPTIONAL — when omitted, the platform fills them in from your tool history."
        )
